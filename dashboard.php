                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h6 class="card-title float-left" style="margin-top: 5px">
                                <?php
                            ...
                            <h6 class="card-title float-right" style="margin-top: 5px">
                                    Select Year:
                            ...
                            <table class="table">
                                <thead>
                                        <tr>
                                            ...
                                            <th scope="col">Ending<br> Enrolments</th>
